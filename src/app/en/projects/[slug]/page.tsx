...
import { enProjects } from '@/config/enPortfolio'
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const detail = await getProjectDetail(slug, 'en')
  if (!detail) {
...
export default async function EnglishProjectDetailPage({ params }: Props) {
  ...
  const detailProjects = enProjects.filter((project) => project.slug)
