...
export function GithubProjectCard({
  ...
  return (
    <li className="group relative flex h-full flex-col items-start">
      <div className="relative flex h-full w-full flex-col justify-between rounded-lg border border-muted-foreground/20 px-6 py-5 shadow-sm transition-all group-hover:scale-[1.02] group-hover:bg-muted/5 group-hover:shadow-md">
        <div className="">
